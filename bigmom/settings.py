"""
Django settings for bigmom project.
...
SECRET_KEY = '-taf&ec2$!i$!7o=p7^ha2v=9()lob^=un50^iv6yy#l83re9g'
...
WSGI_APPLICATION = 'bigmom.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(BASE_DIR, 'bigmom_db.sqlite3'),
    }
}
